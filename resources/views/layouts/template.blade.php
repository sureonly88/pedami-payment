...
<head>
  ...
  <link rel="stylesheet" href="{{ secure_asset('ionicons/css/ionicons.min.css') }}">
  ...
  <![endif]-->
  <link rel="stylesheet" href="{{ secure_asset('jquery-ui/jquery-ui.min.css') }}">

  <link rel="stylesheet" href="{{ secure_asset('styles/dataTables.bootstrap.css') }}">

  <script src="{{ secure_asset('plugins/jQuery/jquery-2.2.3.min.js') }}"></script>
  <script src="{{ secure_asset('jquery-ui/jquery-ui.min.js') }}"></script>

  <script src="{{ secure_asset('js/jqmq.js') }}"></script>
  ...
  <script src="{{ secure_asset('js/numeral.min.js') }}"></script>

  @if (env('APP_DEBUG'))
  <script src="{{ secure_asset('vuejs/vue.js') }}"></script>
  @else
  <script src="{{ secure_asset('vuejs/vue.min.js') }}"></script>
  @endif
  <script src="{{ secure_asset('js/axios.min.js') }}"></script>
  <script src="{{ secure_asset('js/linq.min.js') }}"></script>
...
<!--   <script src="https://cdn.jsdelivr.net/vue2-filters/0.1.7/vue2-filters.min.js"></script>
  ...
  <script src="{{ secure_asset('js/vue2-filters.min.js') }}"></script>
  <script src="{{ secure_asset('js/vue-resource.min.js') }}"></script>
...
<!-- <script src="{{ secure_asset('js/app.kopkar.js') }}"></script> -->
...
<!-- AdminLTE App -->
<script src="{{ secure_asset('dist/js/app.min.js') }}"></script>

<link rel="stylesheet" href="{{ secure_asset('css/animate.css') }}">
<script src="{{ secure_asset('js/bootstrap-notify.min.js') }}"></script>

<!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/socket.io/1.7.3/socket.io.min.js"></script> -->
<script src="{{ secure_asset('js/socket.io.min.js') }}"></script>

<script src="{{ secure_asset('app/kopkar.js') }}"></script>

<script src="{{ secure_asset('printing/dependencies/rsvp-3.1.0.min.js') }}"></script>
<script src="{{ secure_asset('printing/dependencies/sha-256.min.js') }}"></script>
<script src="{{ secure_asset('printing/qz-tray.js') }}"></script>
<script src="{{ secure_asset('printing/print_java.js') }}"></script>
